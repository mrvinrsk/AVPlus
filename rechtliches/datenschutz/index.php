...
<head>
    ...
    <title>AVPlus | Datenschutz</title>
...
<main role="main">
    <div class="container-lg mt-2 mt-lg-5">
        ...
        <p>Login (bis der Browser geschlossen wird)
            <br>Warenkorb (7 Tage)</p>
        ...
        <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung.
            Ohne
            die Bereitstellung Ihrer personenbezogenen Daten können wir Ihnen keinen Zugang auf unsere angebotenen
            Inhalte
            gewähren. </p>
        <p></p>
        ...
        <h3>Rechtsgrundlage:</h3>
        <p>Die Verarbeitung der Daten, die für den Abschluss des Vertrages erforderlich ist, basiert auf Art. 6 Abs. 1
            lit.
            b DSGVO.</p>
        <h3>Empfänger:</h3>
        ...
        <p>marvin.rosskothen@outlook.de</p>

...
<style>
    ...
    .redirect:not(.disabled):hover div {
...
<main role="main" class="container-lg">
    <div class="row py-2 px-4 g-3 mt-3 mt-lg-5">
        <h3 class="text-primary">Administration</h3>
        <h5 class="text-secondary">
            In dieser Administrations-Oberfläche hast du die Möglichkeit Kunden, Artikel & Kategorien zu hinzuzufügen
            und zu verwalten.
        ...
        <div class="container mt-5 mt-lg-4">
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-1 g-sm-2 g-lg-3">
                ...
                <div class="col redirect" onclick="window.location = 'articles/';">
                    <div class="p-3 bg-primary text-light">Artikelverwaltung</div>
                </div>
                <div class="col">
                    <div class="p-3 bg-secondary text-light disabled">Rangverwaltung</div>
                </div>
            </div>
        </div>
    </div>
